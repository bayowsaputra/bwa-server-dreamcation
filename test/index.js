...
chai.use(chaiHttp);
//lihat di function landing-page
describe('API ENDPOINT TESTING', () =>{
  ...
  //lihat di function Booking-page 
  it('GET Booking Page', (done) => {
    const image = __dirname + '/buktibayar.jpeg';
    const dataSample = {
      //data sample yang akan ditampilkan di monggoseDB
      image,
      idItem:'5e96cbe292b97300fc902223',
      duration:'2',
      bookingStartDate:'10-4-2020',
      bookingEndDate:'12-4-2020',
      firstName:'Robin',
      lastName:'Max',
      email:'robin@gmail.com',
      phoneNumber:'0815-2222-3333',
      accountHolder:'robin',
      bankFrom:'BRI',
    }
    chai.request(app).post('/api/v1/member/booking-page')
      ...
      .end((err, res) => {
        ...
        expect(res.body.booking).to.have.all.keys('payments', '_id', 'invoice', 'bookingStartDate', 'bookingEndDate', 
